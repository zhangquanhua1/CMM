<template>
  <div class="app-container">
    ...
    <!--       出库-->
    <el-dialog :title="title" :visible.sync="openOutStock" :close-on-click-modal="false" width="50%" class="spec-dialog"
               v-dialog-drag append-to-body
    >
      <el-table
        :data="Items2"
      ...
      >
        ...
        <el-table-column label="出库数量" align="center"  prop="" width="200">
          <template slot-scope="scope">
            <el-input-number  :min="0" :max="scope.row.Max" v-model="scope.row.amount" label="数量" width="100px"></el-input-number>
          </template>
        </el-table-column>
